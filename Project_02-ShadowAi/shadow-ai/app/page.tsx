      ...
      <div className="container mx-auto p-8">
        ...
        <nav className="flex justify-between items-center mb-24">
          ...
          <div className="hidden md:flex items-center gap-8 font-semibold">
            ...
            <a href="#" className="hover:text-gray-300">PERSONAS</a>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              <a href="/chat/hitesh-choudhary" className="flex items-center p-4 bg-[#2a2a2a] rounded-xl hover:bg-[#3a3a3a] transition-colors">
                <div className="w-16 h-16 rounded-full bg-gray-500 mr-4"></div>
                <span className="text-xl font-semibold">HITESH CHOUDHARY</span>
              </a>
              <a href="/chat/piyush-garg" className="flex items-center p-4 bg-[#2a2a2a] rounded-xl hover:bg-[#3a3a3a] transition-colors">
                <div className="w-16 h-16 rounded-full bg-gray-500 mr-4"></div>
